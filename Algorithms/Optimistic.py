...
def A_Optimistic(network:M_Network=None,k:Ks=None,log:bool=True,speed:bool=False,threads:bool=False,lp:bool=False,extra:bool=False) -> Result:
    '''
    --------- Input -------------------------
